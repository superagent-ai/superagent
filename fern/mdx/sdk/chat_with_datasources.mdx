With Superagent you can easilly create an AI Assistant that has access to your private data thorugh a conecpt we call `Datasources`. 
...
2. Now let's create a datasource by uploading Teslas Q3 2023 Earnings report to Superagent. Note that the `description` key tells the Assistant when this datasource should be used. Be vary of what you put in as your description as it might effect the Assistants behaviour. 
<CodeBlocks>
    <CodeBlock title="Python">
        ```python 
