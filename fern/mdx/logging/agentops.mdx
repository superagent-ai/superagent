...
**Website** - [agentops.ai](https://agentops.ai/) **GitHub** - [AgentOps Github](https://github.com/AgentOps-AI/agentops)
...
Superagent provides a default org key that grants users access to specialized analytics features. However, you may also remove it or replace it with your own.