...
First setup supabase. Refer to our guide [Supabase setup](https://docs.superagent.sh/overview/deployments/render). The guide explains how to run Supabase with docker compose using our provided example.
