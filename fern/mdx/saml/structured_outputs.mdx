...
workflows:
  - anthropic:
      ...
      prompt: You're an helpful assistant.
      output_schema:
        products: 
...
You can ask for `I need a list books from Amazon about programming.`. The scraper tool will scrape the data from Amazon's website and return the data in the format you have defined in the output schema.