...
export const SCAN_SYSTEM_PROMPT = `# Standard Operating Procedures: Security Analysis Guidelines
...
Now scan this repository and output a comprehensive security report.`;
