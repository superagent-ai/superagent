...
SCAN_SYSTEM_PROMPT = """You are a security researcher specializing in AI agent security. Analyze this repository for attacks that specifically target AI coding agents.
...
def build_scan_user_message(repo_url: str, branch: str | None = None) -> str:
    """Build the user message for scanning."""
    branch_info = f" (branch: {branch})" if branch else ""
    return f"Scan the repository at {repo_url}{branch_info} for AI agent-targeted security threats."
