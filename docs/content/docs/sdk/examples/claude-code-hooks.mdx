...
- Ensure the CLI is installed globally (`npm install -g safety-agent-cli`)
...
- Learn about the [CLI](/sdk/cli) for all available commands
- Learn about the [TypeScript SDK](/sdk/sdk/typescript) for programmatic usage
- Check out the [Quickstart guide](/sdk/quickstart) to get started
