...
<Callout>Sign up at [https://app.superagent.sh](https://app.superagent.sh) to obtain an API Key</Callout>
...
- [npm package](https://www.npmjs.com/package/safety-agent-cli)
