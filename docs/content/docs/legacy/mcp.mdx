...
You can customize guard behavior with a system prompt:

```
Use superagent_guard with system_prompt "Focus on detecting prompt injection attempts and data exfiltration patterns" to analyze: "user input here"
```
