...
- Learn about [scanning file uploads](/legacy/examples/scan-file-uploads) for more details
- Explore [Vercel AI SDK integration](/legacy/agent-frameworks/vercel-ai-sdk)
- Check out [Guard API reference](/legacy/rest-api/guard)
