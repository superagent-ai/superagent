...
- Explore [Guard API](/legacy/rest-api/guard) for detailed API reference
- Learn about [Redact API](/legacy/examples/redact-pdfs) for removing PII from uploads
- Check out [Vercel AI SDK integration](/legacy/agent-frameworks/vercel-ai-sdk) for more examples
