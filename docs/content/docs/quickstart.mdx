...
[Superagent](https://superagent.sh) provides three purpose-trained models — Guard, Verify, and Redact — available as standalone APIs that protect AI applications in real time.
...
<Cards>
  <Card title="Guard" href="/capabilities/guard">
    Learn how to protect against prompt injections and malicious inputs
  </Card>
  <Card title="Verify" href="/capabilities/verify">
    Validate model outputs against trusted sources
  </Card>
  <Card title="Redact" href="/capabilities/redact">
