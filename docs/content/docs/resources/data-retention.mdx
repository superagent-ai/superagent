...
- **No file storage**: Uploaded files (for Guard, Redact, or Analyze) are immediately discarded after processing
...
**Superagent does not train models on your data** unless you explicitly request it. The Safety Agent methods (Guard, Redact, and Analyze) are pre-trained and deployed for production use.
