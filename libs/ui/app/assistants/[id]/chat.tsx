...
export default function Chat({
  ...
  return (
    <div className="flex h-full space-x-12 border-t">
      <div className="relative flex flex-1 flex-col overflow-hidden">
        <ScrollArea className="relative flex grow flex-col px-4">
          <div className="absolute inset-x-0 top-0 z-20 h-10 bg-gradient-to-b from-background from-0% to-transparent to-100%" />
          {selectedView === "chat" ? (
            <div className="mb-20 flex flex-col space-y-5 py-5">
        ...
        {selectedView === "chat" && (
          <div className="absolute inset-x-0 bottom-0 z-50 h-20 bg-gradient-to-t from-background from-10% to-transparent to-50%">
